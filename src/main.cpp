...
int main() { // точка входа в прогу
    SetConsoleCP(1251); // ставим кодовую страницу 1251 на ввод консоли (чтоб кириллица была)
    SetConsoleOutputCP(1251); // ставим кодовую страницу 1251 на вывод (чтоб крякозябр не было)
